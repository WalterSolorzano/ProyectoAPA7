...
export default defineConfig({
  ...
  server: {
    ...
    headers: {
      ...
      'Content-Security-Policy': 'default-src \'self\' https://localhost:3000 https://127.0.0.1:8742 http://127.0.0.1:8742 http://localhost:8742; img-src \'self\' data: https:; style-src \'self\' \'unsafe-inline\'; script-src \'self\' \'unsafe-inline\' \'unsafe-eval\' https://localhost:3000;',
    },
  },
  build: {
    outDir: 'dist',
